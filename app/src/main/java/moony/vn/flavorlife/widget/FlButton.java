...
public class FlButton extends Button {
    private static final int ELLE_BASKERVILLE_BOLD = 0;
    private static final int ELLE_BASKERVILLE_BOLD_IT = 1;
    private static final int ELLE_BASKERVILLE_ITALIC = 2;
    private static final int ELLE_BASKERVILLE_REGULAR = 3;
    private static final int ELLE_BASKERVILLE_SEMIBOLD = 4;
    private static final int ELLE_BASKERVILLE_SEMIBOLD_IT = 5;
    ...
    public FlButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FlButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            font = ta.getInt(R.styleable.FlTextView_font, ELLE_BASKERVILLE_SEMIBOLD);
