...
public class NMediaItem implements Parcelable {
	 ...
	 * 
	 * @param mediaType
	 *            Whether {@link #PHOTO} or {@link #VIDEO}
	 * @param uriOrigin
	 *            {@link Uri} of media item.
	 */
	...
	public static final Parcelable.Creator<NMediaItem> CREATOR = new Creator<NMediaItem>() {
