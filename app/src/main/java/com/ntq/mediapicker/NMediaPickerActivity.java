...
public class NMediaPickerActivity extends NActivity implements
        NMediaSelectedListener, NCropListener, OnBackStackChangedListener {
    ...
    private OnFileCreatedListener mOnFileCreatedListener = new OnFileCreatedListener() {
